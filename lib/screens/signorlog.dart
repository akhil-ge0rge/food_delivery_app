...
class SignInOrLogInScreen extends StatefulWidget {
  const SignInOrLogInScreen({Key? key}) : super(key: key);

  @override
  State<SignInOrLogInScreen> createState() => _SignInOrLogInScreenState();
}

class _SignInOrLogInScreenState extends State<SignInOrLogInScreen> {
  @override
